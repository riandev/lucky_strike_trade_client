...
const LeadGenerate = () => {
  ...
  const generateInitial = () => {
    fetch("http://192.168.10.11:5006/initialLead?initDate=" + initialDate)
      .then((res) => res.json())
      .then((data) => {
        setInitialLeads(
          data
  ...
  const updateInitialLeads = () => {
    fetch("http://192.168.10.11:5006/updateInitialLead", {
      method: "PATCH",
  ...
  const regenerateLeads = () => {
    fetch("http://192.168.10.11:5006/regenerate?regenDate=" + regenDate)
      .then((res) => res.json())
      .then((data) => {
        setRegenerate(
          data
  ...
  const regenerateUpdate = () => {
    fetch("http://192.168.10.11:5006/regenerateUpdate", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
